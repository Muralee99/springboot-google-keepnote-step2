...
public class NoteController {
	...
	{
		return new ModelAndView("index","list", noteDAO.getAllNotes());
	}
	...
	{
		//RedirectView review = null;
		note.setCreatedAt(LocalDateTime.now());
		final boolean isSaved = noteDAO.saveNote(note);
	...
	{
		boolean isUpdated = noteDAO.UpdateNote(note);
